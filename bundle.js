// Mostly copied from:
// https://github.com/vuejs/vue-router/blob/dev/build/build.js
...
const entry = resolve('.tsc-out/index.js');

// remove `this` checking;
fs.writeFileSync(entry, fs.readFileSync(entry).toString().replace(
  /\(this && this\.__.+?\) \|\| /g,
  ''
));
