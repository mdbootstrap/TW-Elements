...
export const DefaultClasses = {
  ...
  notchLeadingNormal:
    "border-secondary-500 dark:border-neutral-400 group-data-[te-input-focused]:shadow-notch-1 group-data-[te-input-focused]:border-primary",
  notchLeadingWhite:
    "border-neutral-200 group-data-[te-input-focused]:shadow-notch-1 group-data-[te-input-focused]:shadow-white group-data-[te-input-focused]:border-white",
  notchMiddle:
  ...
  notchMiddleNormal:
    "border-secondary-500 dark:border-neutral-400 group-data-[te-input-focused]:shadow-notch-2 group-data-[te-input-focused]:border-primary",
  notchMiddleWhite:
    "border-neutral-200 group-data-[te-input-focused]:shadow-notch-2 group-data-[te-input-focused]:shadow-white group-data-[te-input-focused]:border-white",
  notchTrailing:
  ...
  notchTrailingNormal:
    "border-secondary-500 dark:border-neutral-400 group-data-[te-input-focused]:shadow-notch-3 group-data-[te-input-focused]:border-primary",
  notchTrailingWhite:
    "border-neutral-200 group-data-[te-input-focused]:shadow-notch-3 group-data-[te-input-focused]:shadow-white group-data-[te-input-focused]:border-white",
