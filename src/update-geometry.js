...
function updateCss(element, i) {
  ...
  if (i.isScrollbarYUsingRight) {
    if (i.isRtl) {
      yRailOffset.right = ( i.element.scrollWidth - i.element.scrollLeft ) - i.containerWidth;
    } else {
      yRailOffset.right = i.scrollbarYRight - element.scrollLeft;
    }
  } else {
    if (i.isRtl) {
      yRailOffset.left = i.containerWidth - ( i.element.scrollWidth - i.element.scrollLeft );
    } else {
