...
(function () {
  ...
  Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
    ...
    linkCopy.classList = 'btn-copy-code text-blue-500 bg-transparent border border-solid border-blue-500 hover:bg-blue-500 hover:text-white active:bg-primary font-bold uppercase text-sm px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150';
